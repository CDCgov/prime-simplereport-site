...
## Request access for your testing facility
To get access, fill out the [SimpleReport facility access request form]({% link pages/form.html %}). If you have multiple facilities, fill out the form separately for each facility. (If you have three facilities, you’ll fill out the form three times.)
