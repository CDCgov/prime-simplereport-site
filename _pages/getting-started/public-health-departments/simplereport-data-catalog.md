...
SimpleReport sends test results to public health departments as HL7 2.5.1 ELR (electronic lab results) through the [AIMS platform](https://aimsplatform.com/#/landing).
