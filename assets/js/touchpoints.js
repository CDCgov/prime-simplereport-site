    ...
    return {
        ...
        ajaxPost: function (form, callback) {
            ...
            var params = {
                ...
                answer_03:
                    form.querySelector("input[name=answer_03]:checked") && form.querySelector("input[name=answer_03]:checked").value,
                answer_10:
                    form.querySelector("input[name=answer_10]:checked") && form.querySelector("input[name=answer_10]:checked").value,
                answer_08:
                    form.querySelector("#answer_08") && form.querySelector("#answer_08").value,
                answer_06:
                    form.querySelector("input[name=answer_06]:checked") && Array.apply(null, form.querySelectorAll("input[name=answer_06]:checked")).map(function (x) { return x.value; }).join(','),
                answer_05:
                    form.querySelector("#answer_05") && form.querySelector("#answer_05").value,
            }
